 ...
 *   https://datatables.net/download/#bs4/dt-1.12.1/r-2.3.0/sb-1.3.3/sp-2.0.1/sl-1.4.0
 *
 * Included libraries:
 *   DataTables 1.12.1, Responsive 2.3.0, SearchBuilder 1.3.3, SearchPanes 2.0.1, Select 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.12.1/r-2.3.0/sb-1.3.3/sp-2.0.1/sl-1.4.0",
